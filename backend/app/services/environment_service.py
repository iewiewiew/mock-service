...
class EnvironmentService:
    ...
    @staticmethod
    def update_environment(environment_id, data):
        """更新环境"""
    ...
    @staticmethod
    def create_environment_parameter(environment_id, data):
        """创建环境参数"""
    ...
    @staticmethod
    def update_environment_parameter(parameter_id, data):
        """更新环境参数"""
    ...
    @staticmethod
    def copy_environment(environment_id, new_name):
        """复制环境及其参数"""
