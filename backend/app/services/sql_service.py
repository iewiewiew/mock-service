...
class SQLService:
    ...
    def get_all_templates():
        """获取所有SQL模板"""
        return SQLTemplate.query.order_by(SQLTemplate.category, SQLTemplate.id.asc()).all()
    ...
    def get_query_history(limit=50):
        """获取查询历史"""
        return QueryHistory.query.order_by(QueryHistory.created_at.desc()).limit(limit).all()
