...
def create_environment():
    ...
    try:
        result = EnvironmentService.create_environment(data)
...
def update_environment(environment_id):
    ...
    try:
        result = EnvironmentService.update_environment(environment_id, data)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def copy_environment(environment_id):
    ...
    try:
        result = EnvironmentService.copy_environment(environment_id, new_name)
        return jsonify(result), 201
    except APIException as e:
        raise e
    except Exception as e:
...
def create_environment_parameter(environment_id):
    ...
    try:
        result = EnvironmentService.create_environment_parameter(environment_id, data)
        return jsonify(result), 201
    except APIException as e:
        raise e
    except Exception as e:
...
def update_environment_parameter(parameter_id):
    ...
    try:
        result = EnvironmentService.update_environment_parameter(parameter_id, data)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
