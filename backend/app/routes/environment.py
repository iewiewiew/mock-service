...
def get_all_environments():
    ...
    try:
        result = environment_service.get_all_environments(page=page, per_page=per_page, search=search,
...
def get_environment_by_id(environment_id):
    ...
    try:
        environment = environment_service.get_environment_by_id(environment_id)
...
def create_environment():
    ...
    try:
        result = environment_service.create_environment(data)
...
def update_environment(environment_id):
    ...
    try:
        result = environment_service.update_environment(environment_id, data)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def delete_environment(environment_id):
    ...
    try:
        result = environment_service.delete_environment(environment_id)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def copy_environment(environment_id):
    ...
    try:
        result = environment_service.copy_environment(environment_id, new_name)
        return jsonify(result), 201
    except APIException as e:
        raise e
    except Exception as e:
...
def get_environment_stats(environment_id):
    ...
    try:
        result = environment_service.get_environment_stats(environment_id)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def get_environment_parameters(environment_id):
    ...
    try:
        result = environment_service.get_environment_parameters(environment_id, page=page, per_page=per_page,
            search=search)
        return jsonify(result)
    except APIException as e:
        raise e
...
def create_environment_parameter(environment_id):
    ...
    try:
        result = environment_service.create_environment_parameter(environment_id, data)
        return jsonify(result), 201
    except APIException as e:
        raise e
    except Exception as e:
...
def update_environment_parameter(parameter_id):
    ...
    try:
        result = environment_service.update_environment_parameter(parameter_id, data)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def delete_environment_parameter(parameter_id):
    ...
    try:
        result = environment_service.delete_environment_parameter(parameter_id)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
...
def export_environment(environment_id):
    ...
    try:
        ...
        # 获取环境参数
        parameters_result = environment_service.get_environment_parameters(environment_id, page=1, per_page=1000
            # 假设最多1000个参数
        )
...
def search_environments():
    ...
    try:
        ...
        result = environment_service.get_all_environments(page=page, per_page=per_page, search=search_condition,
            project_id=project_id)
