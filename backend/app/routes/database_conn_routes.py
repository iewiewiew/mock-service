...
from ..services.database_conn_service import DatabaseConnService
...
def get_all_connections():
    ...
    try:
        result = DatabaseConnService.get_all_connections(page=page, per_page=per_page, search=search)
...
def create_connection():
    ...
    try:
        result = DatabaseConnService.create_connection(data)
...
def update_connection(connection_id):
    ...
    try:
        result = DatabaseConnService.update_connection(connection_id, data)
        return jsonify(result)
    except APIException as e:
        raise e
    except Exception as e:
