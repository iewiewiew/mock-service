      ...
      <el-card class="quick-actions-card" shadow="never">
        ...
        <div class="actions-grid">
          ...
          <div class="action-item" @click="handleQuickAction('linuxInfo')">
            ...
            <span class="action-text">Linux服务器</span>
          </div>
          <div class="action-item" @click="handleQuickAction('mockList')">
            <div class="action-icon" style="background-color: #fa8c16;">
              <el-icon><List /></el-icon>
            </div>
            <span class="action-text">接口列表</span>
          </div>
        </div>
      </el-card>
    </div>
