  ...
  <div class="common-list-container">
    <div class="common-header-bar">
      ...
      <div class="common-action-bar">
        <el-button type="primary" @click="handleCreateButtonClick">创建 Mock 接口</el-button>
      </div>
    </div>
    ...
    <el-dialog v-model="showCreateDialog" title="创建 Mock 接口">
      <mock-form ref="createFormRef" @submit="handleCreate" @cancel="showCreateDialog = false" />
    </el-dialog>

    <el-dialog v-model="showEditDialog" title="编辑 Mock 接口">
